...
export class EnvHelper {
  ...
  static bscTestnetURI = 'https://data-seed-prebsc-1-s1.binance.org:8545/';
  static bscNetURI = 'https://bsc-dataseed1.defibit.io/';
   ...
   */
  static getAlchemyAPIKeyList(networkId) {
    let ALCHEMY_ID_LIST = [];
    let uriPath;
   ...
   */
  static getSelfHostedNode(networkId) {
    let URI_LIST = [];
    switch (networkId) {
      case 1:
        if (
  ...
  static getFallbackURIs(networkId) {
