...
const CardItems = [
  ...
  },
  {
    ...
    likes: '1.2',
    img: '3',
    title: 'Bapha domaine name',
    price: '2.45',
    stock: '6',
  },
];

function CardMarketDomain() {
  const ref = useRef();
              ...
              <div className="card_body space-y-10">
                ...
                <div className="card_head">
                  <Link to="Item-details">
                    <img
                      src={`img/items/domain/${val.img}.png`}
                      alt="nftimage"
                    />
                  </Link>
...
export default CardMarketDomain;
